          ...
          <v-container class="fill-height" fluid>
              <v-row align="center" justify="center" dense>
                  <v-col cols="12" sm="8" md="4" lg="4">
                      ...
                      <v-card elevation="12">
                          <v-img :src="require(`@/assets/eduplan-logo.png`)"
                          ...
                          <v-card-text>
                              <v-form>
                                  ...
                                  <v-btn href="/dashboard" class="rounded-2" color="black" x-large block dark>Login</v-btn>
                                  <v-card-actions class="text--secondary">
                                      <v-checkbox color="black" label="Remember me"></v-checkbox>
                                      <v-spacer></v-spacer>
                                      No account? 
                                      <v-btn class="rounded-2 ml-2" href="/register" x-small color="orange darken-3" dark>Register</v-btn
>
                                  </v-card-actions>
                              </v-form>
                          </v-card-text>
                  ...
                  <!-- <v-col cols="12" md="4" class="teal accent-3">
                      ...
                      <div class="text-center">
                          <v-btn class="rounded-2">Register</v-btn>
                      </div>
                  </v-col> -->
              </v-row>  
          </v-container>
